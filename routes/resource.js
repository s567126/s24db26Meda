...
router.post('/createfish', fish_controller.fish_create_post);
// DELETE request to delete fish.
router.delete('/deletefish/:id', fish_controller.fish_delete);
// PUT request to update fish.
router.put('/updatefish/:id', fish_controller.fish_update_put);
